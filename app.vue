<template>
    <div class="min-h-screen bg-gray-100 flex flex-col justify-center items-center">
      ...
      <footer class="text-gray-400 text-center text-sm p-4">
        <div class="text-xs">
            <strong>Legal Disclaimer:</strong> Deze applicatie is bedoeld voor informatieve doeleinden. Ik ben niet aansprakelijk voor enige fouten of omissies, of voor de resultaten verkregen uit het gebruik van deze informatie.
        </div>
        <div class="mt-3 text-xs">
          ...
          Voertuiggegevens door <a href="https://opendata.rdw.nl/" class="text-blue-500 hover:text-blue-400" target="_blank" rel="noopener noreferrer">RDW Open Data</a>.
        </div>
        </footer>
    </div>
  </template>
